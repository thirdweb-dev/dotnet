...
public class InAppWallet : EcosystemWallet
{
    ...
    internal InAppWallet(
        ...
        : base(null, null, client, embeddedWallet, httpClient, email, phoneNumber, authProvider, siweSigner, walletSecret, executionMode, delegationContractAddress)
    {
    ...
    )
    {
        ...
        var ecoWallet = await Create(client, null, null, email, phoneNumber, authProvider, storageDirectoryPath, siweSigner, walletSecret, twAuthTokenOverride, executionMode);
