    ...
    )
{
    ...
    public BigInteger? FromChainId { get; set; } = fromChainId;

    /// <summary>
    /// The address of the source token.
    /// </summary>
    [JsonProperty("fromTokenAddress")]
    public string FromTokenAddress { get; set; } = fromTokenAddress;
    ...
    public string FromAmountWei { get; set; } = fromAmountWei;

    /// <summary>
    /// The chain ID of the destination token.
    /// </summary>
    [JsonProperty("toChainId")]
    public BigInteger? ToChainId { get; set; } = toChainId;
